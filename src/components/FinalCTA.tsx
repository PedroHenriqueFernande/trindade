  ...
  return (
    <section className="bg-black text-[#F3F3F3] py-8 px-6 relative">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#E5C558]/5 rounded-full blur-3xl opacity-5"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          <Flame className="text-[#E5C558]" size={28} />
          <h2 className="font-['Bebas_Neue'] font-normal text-4xl md:text-5xl leading-tight bg-gradient-to-r from-[#E5C558] to-[#C9AD6A] bg-clip-text text-transparent tracking-wide">
        ...
        <div className="bg-gradient-to-br from-[#1A1A1A] to-black border border-[#E5C558] border-opacity-40 rounded-2xl p-10 md:p-14 mb-4">
          <div className="mb-6">
            ...
            <div className="space-y-6 text-left max-w-2xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-[#E5C558] to-[#C9AD6A] border-l-4 border-[#AD9255] rounded-lg pl-6 pr-4 py-4">
                <p className="font-['Inter'] text-lg">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <Lock className="text-[#E5C558]" size={24} />
            <p className="font-['Montserrat'] font-extrabold text-2xl bg-gradient-to-r from-[#E5C558] to-[#C9AD6A] bg-clip-text text-transparent">
        ...
        <p className="mt-10 text-[#A0A0A0] font-['Inter'] text-sm flex items-center justify-center gap-4">
          <span className="flex items-center gap-2"><Flame size={16} className="text-[#E5C558]" /> Acesso imediato</span>
          <span>•</span>
          <span className="flex items-center gap-2"><Lock size={16} className="text-[#E5C558]" /> Pagamento 100% seguro</span>
          <span>•</span>
