  ...
  return (
    <section className="bg-black text-[#F3F3F3] py-8 px-6 relative">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/2 -left-40 -translate-y-1/2 w-80 h-80 bg-[#D4AF37]/5 rounded-full blur-3xl opacity-5"></div>
      </div>

      <div className="max-w-4xl mx-auto relative z-10">
        <div className="h-px bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent mb-6"></div>

        <div className="bg-gradient-to-br from-[#1A1A1A] to-black border border-[#D4AF37] border-opacity-40 rounded-2xl p-10 md:p-14 text-center">
          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-br from-[#D4AF37] to-[#F4E5B0] rounded-full p-8 shadow-2xl">
          ...
          <div className="mt-12 bg-gradient-to-r from-[#D4AF37] via-[#F4E5B0] to-[#D4AF37] border-2 border-[#D4AF37] border-opacity-60 rounded-xl p-8 mb-4">
